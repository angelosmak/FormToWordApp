...
class FormSubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_submission" do
    assert_difference("FormSubmission.count") do
      post form_submissions_url, params: { form_submission: { email: @form_submission.email, message: @form_submission.message, name: @form_submission.name } }
    end
  ...
  test "should update form_submission" do
    patch form_submission_url(@form_submission), params: { form_submission: { email: @form_submission.email, message: @form_submission.message, name: @form_submission.name } }
